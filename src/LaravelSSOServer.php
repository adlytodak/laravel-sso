...
namespace AdlyTodak\LaravelSSO;

use Illuminate\Database\Eloquent\ModelNotFoundException;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Cache;
use Illuminate\Support\Facades\Session;
use AdlyTodak\SimpleSSO\SSOServer;
use AdlyTodak\LaravelSSO\Resources\UserResource;
...
class LaravelSSOServer extends SSOServer
{
    ...
    {
        try {
            $user = config('laravel-sso.usersModel')::where('email', $username)->with('staff.dept')->firstOrFail();
        } catch (ModelNotFoundException $e) {
            return null;
        }
